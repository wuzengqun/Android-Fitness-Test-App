package com.example.facedetect.faceserver;
...
import com.example.facedetect.model.FaceRegisterInfo;
...
public class FaceServer {
     ...
     * @return 已注册人脸名称的列表
     */
    public List<String> getAllRegisteredFaceNames() {
    ...
    public boolean registerBgr24(Context context, byte[] bgr24, int width, int height, String name) {
        synchronized (this) {
            ...
            if (code == ErrorInfo.MOK && faceInfoList.size() > 0) {
                ...
                Log.d(TAG, "Detected face rect: " + faceInfoList.get(0).getRect());
                Log.d(TAG, "Face orientation: " + faceInfoList.get(0).getOrient());
                //特征提取
