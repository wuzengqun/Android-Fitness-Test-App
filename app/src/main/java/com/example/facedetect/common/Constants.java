package com.example.facedetect.common;

public class Constants {

    public static final String APP_ID = "C3GKA3Qn4gvMXG8GkbYvu6csRn1rFrJmLZeC267RXG7n";
    public static final String SDK_KEY = "GiLpyBs1ahcEfrSHqukLWdVrDWU3mzqLweLZHRvHwhuQ";
