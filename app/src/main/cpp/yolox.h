...
extern value_result v2;
extern value_result v1;
...
public:
    ...
    struct value_result draw(cv::Mat& rgb, const std::vector<Pose>& objects,int selectmode);

    bool ispullupStandard(const float* preds);
